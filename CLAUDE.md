...
Siyahi ("ink") is Saumitra S. Phatak's static, multilingual poetry archive: 108 original poems (plus ~33 short aphorisms) in Hindi, Marathi, and English, presented as a searchable/browsable website with a separate original "book edition" view.
...
2. Regenerate the data file:
   ...
   python3 scripts/build_content.py
   ```
3. Confirm it printed `Wrote 108 poems and ... aphorisms to .../js/poems-data.js` with no error.
